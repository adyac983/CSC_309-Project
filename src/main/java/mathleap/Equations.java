...
public class Equations {
    ...
    public static double solveEasyEquation(String equation) {
    ...
    public static double solveMidEquation(String equation) {
        String[] parts = equation.split(" ");
        double coefX = Double.parseDouble(parts[0].replace("x", ""));
    ...
    public static double solveHardEquation(String equation) {
        String[] parts = equation.split(" ");
